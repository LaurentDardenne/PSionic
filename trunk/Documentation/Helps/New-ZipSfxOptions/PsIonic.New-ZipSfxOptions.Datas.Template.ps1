...
$Datas = @{
	...
	NewZipSfxOptionsParametersAdditionalCompilerSwitches = ''
	NewZipSfxOptionsParametersCmdLine = ''
	NewZipSfxOptionsParametersCopyright = ''
	...
	NewZipSfxOptionsParametersNameOfProduct = ''
	NewZipSfxOptionsParametersQuiet = ''
	NewZipSfxOptionsParametersRemove = ''
	NewZipSfxOptionsParametersVersionOfProduct = ''
	NewZipSfxOptionsParametersWindowTitle = ''
	...
	NewZipSfxOptionsExamplesRemarks1 = ''
}
