...
During this test, it is also possible to check if the archive is valid and in this case attempt to fix it. 
...
"@
	TestZipFileParametersRepair = 'Tent repair if archive is corrupt.'
...
It is found that a self-extracting archive is considered as a valid archive. The return value is $true.
'@
