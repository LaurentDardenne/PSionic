...
"@
	...
	NewProgressBarInformationsOutputsDescription1 = 'Son typename est ProgressBarInformations.'
...
Cet exemple lit toutes les archives ZIP du répertoire C:\Temp, puis les extrait.
