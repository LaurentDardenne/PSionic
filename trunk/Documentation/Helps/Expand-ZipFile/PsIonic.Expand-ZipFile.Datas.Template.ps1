...
$Datas = @{
	...
	ExpandZipFileSetsDefault = ''
	ExpandZipFileSetsList = ''
	...
	ExpandZipFileOutputsDescriptionDefault = ''
	ExpandZipFileOutputsDescriptionIonicZipZipFile = ''
	ExpandZipFileOutputsDescriptionList = ''
	ExpandZipFileOutputsDescriptionIonicZipZipEntry = ''
	ExpandZipFileNotes = ''
