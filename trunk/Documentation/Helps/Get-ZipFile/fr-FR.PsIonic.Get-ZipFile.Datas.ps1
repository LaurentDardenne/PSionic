...
Lors de l'ouverture d'une archive zip de grande taille, vous pouvez choisir d'afficher une barre de progression standardisé.
...
"@
	...
	GetZipFileParametersTempLocation = 'Nom du répertoire temporaire utilisé lors de l''extraction de l''archive. Par défaut récupère le contenu de la variable d''environnement %TEMP%.'
